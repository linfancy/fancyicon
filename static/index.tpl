<div class="index flex flex-v">
    <header class="header flex">
        <div class="header-logo"><span class="ico-logo iconfont icon-f"></span><span class="header-text">ancyicon</span></div>
        <div class="mod-sidebar flex-1">
            ...
            <a href="javascript:;" class="sidebar-ico iconfont icon-reset nodrag" @click="handleUpdate"><span class="ico-text">检查更新</span></a>
        </div>
    </header>
